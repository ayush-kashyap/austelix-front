    ...
    return (
        <div>
            ...
            >
                ...
                />
                <span
                    className='flex-1 text-center text-2xl italic md:block hidden'
                >
                    "Every challenge is a chance to innovate, every failure a lesson, and every launch a new beginning"
                </span>

                <div
                    className='absolute bg-black w-full left-0 md:h-2/10 h-3/10 top-9/10 md:px-40 px-6 flex flex-col'
                >
                    <div
                        className='h-1 bg-secondary md:w-3/5 w-full md:mb-8 mb-4'
                    >
