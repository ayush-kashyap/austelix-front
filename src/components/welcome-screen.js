  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          className="md:text-6xl sm:text-5xl text-2xl text-center md:text-left font-bold font-Mon"
        >
        ...
        <span className="text-xl md:block hidden font-semibold ">
    ...
    >
       <span className='md:text-lg text-xs'> Let's Build Something Great </span>
    <div
